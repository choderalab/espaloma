...
def run(args):
    ...
    exp = esp.TrainAndTest(
        ...
        ds_te=ds_te,
        net=net,
        metrics_tr=[getattr(esp.metrics, metric)() for metric in args.training_metrics],
        metrics_te=[getattr(esp.metrics, metric)() for metric in args.test_metrics],
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_metrics', nargs='*',
        default=['TypingCrossEntropy'])
    parser.add_argument('--test_metrics', nargs='*',
        default=['TypingAccuracy'])

    parser.add_argument('--janossy_config', nargs='*',
        default=[32, 'tanh'])
