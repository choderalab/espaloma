...
def compute_bonds(xyz: torch.Tensor, params: ParameterizedSystem, indices: Indices) -> torch.Tensor:
...
def compute_angles(xyz: torch.Tensor, params: ParameterizedSystem, indices: Indices) -> torch.Tensor:
...
def compute_propers(xyz: torch.Tensor, params: ParameterizedSystem, indices: Indices) -> torch.Tensor:
...
def compute_impropers(xyz: torch.Tensor, params: ParameterizedSystem, indices: Indices) -> torch.Tensor:
...
def compute_valence_energy(offmol: Molecule, xyz: torch.Tensor, params: ParameterizedSystem) -> torch.Tensor:
